		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
					<!-- ============================================================= LOGO ============================================================= -->
<div class="logo">
	<a href="index9ba3.php?page=home">
        ...
        <div class="control-group">
            ...
            <ul class="categories-filter animate-dropdown">
                <li class="dropdown">
                    ...
                    <a class="dropdown-toggle"  data-toggle="dropdown" href="indexe2f2.php?page=category">Categories <b class="caret"></b></a>

                    <ul class="dropdown-menu" role="menu" >
                        <li class="menu-header">Computer</li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="indexe2f2.php?page=category">- Laptops</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="indexe2f2.php?page=category">- Tv & audio</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="indexe2f2.php?page=category">- Gadgets</a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="indexe2f2.php?page=category">- Cameras</a></li>
	...
	<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-4">
							<div class="image">
								<a href="indexbd17.php?page=detail"><img src="assets/images/cart.jpg" alt=""></a>
							</div>
						</div>
						<div class="col-xs-7">
			...
			<div class="clearfix cart-total">
				...
				<a href="index994a.php?page=checkout" class="btn btn-upper btn-primary btn-block m-t-20">Checkout</a>	
			</div><!-- /.cart-total-->
	...
	<div class="nav-outer">
		<ul class="nav navbar-nav">
			<li class="active dropdown yamm-fw">
				<a href="index9ba3.php?page=home" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Home</a>
				<ul class="dropdown-menu">
					<li>
...
<!-- ============================================== WIDE PRODUCTS : END ============================================== -->
			...
			<li class="dropdown yamm">
				<a href="index9ba3.php?page=home" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Desktop</a>
				<ul class="dropdown-menu">
					<li>
						<div class="yamm-content">
    <div class="row">
        <div class='col-sm-12'>
           <div class="col-xs-12 col-sm-12 col-md-4">
			...
			<li class="dropdown">
				...
				<a href="indexe2f2.php?page=category">Electronics
				   <span class="menu-label hot-menu hidden-xs">hot</span>
				</a>
			</li>
			<li class="dropdown hidden-sm">
				
				<a href="indexe2f2.php?page=category">Television
				    <span class="menu-label new-menu hidden-xs">new</span>
				</a>
			</li>

			<li class="dropdown hidden-sm">
				<a href="indexe2f2.php?page=category">Smart Phone</a>
			</li>

			<li class="dropdown">
				<a href="index53a6.php?page=contact">Contact</a>
			</li>
						...
						<div class="yamm-content">
							<div class="row">
									...
									<div class='col-xs-12 col-sm-4 col-md-4'>
	                                  <ul class='links'>
		                                  	<li><a href="index9ba3.php?page=home">Home I</a></li>
											<li><a href="index41b4.php?page=home2">Home II</a></li>
											<li><a href="indexe2f2.php?page=category">Category</a></li>
											<li><a href="index7d8e.php?page=category-2">Category II</a></li>
											<li><a href="indexbd17.php?page=detail">Detail</a></li>
											<li><a href="indexf290.php?page=detail2">Detail II</a></li>
											<li><a href="index4fc0.php?page=shopping-cart">Shopping Cart Summary</a></li>
											
	                                  </ul>
									</div>
									<div class='col-xs-12 col-sm-4 col-md-4'>
	                                  <ul class='links'>
		                                  	<li><a href="index994a.php?page=checkout">Checkout</a></li>
											<li><a href="indexf6f2.php?page=blog">Blog</a></li>
											<li><a href="indexaa69.php?page=blog-details">Blog Detail</a></li>
											<li><a href="index53a6.php?page=contact">Contact</a></li>
											<li><a href="indexa42b.php?page=homepage1">Homepage 1</a></li>
											<li><a href="index2426.php?page=homepage2">Homepage 2</a></li>
											<li><a href="index19d1.php?page=home-furniture">Home Furniture</a></li>
	                                  </ul>
									</div>
									<div class='col-xs-12 col-sm-4 col-md-4'>
										<ul class='links'>
											<li><a href="indexc59d.php?page=sign-in">Sign In</a></li>
											<li><a href="indexf3e3.php?page=my-wishlist">Wishlist</a></li>
											<li><a href="indexec79.php?page=terms-conditions">Terms and Condition</a></li>
											<li><a href="index0b80.php?page=track-orders">Track Orders</a></li>
											<li><a href="indexcb23.php?page=product-comparison">Product-Comparison</a></li>
		                                  	<li><a href="indexfe9c.php?page=faq">FAQ</a></li>
											<li><a href="index4d9f.php?page=404">404</a></li>
	                                  </ul>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">  
                    <li><a href="indexe2f2.php?page=category">Lenovo</a></li>
                    <li><a href="indexe2f2.php?page=category">Microsoft</a></li>    
                    <li><a href="indexe2f2.php?page=category">Fuhlen</a></li>                                        
                    <li><a href="indexe2f2.php?page=category">Longsleeves</a></li>    
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="indexe2f2.php?page=category">Microsoft</a></li>
                    <li><a href="indexe2f2.php?page=category">Apple</a></li>    
                    <li><a href="indexe2f2.php?page=category">Tees & Tanks</a></li>                                        
                    <li><a href="indexe2f2.php?page=category">Graphic Tees</a></li>  
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
                    <li><a href="indexe2f2.php?page=category">Polos</a></li>
                    <li><a href="indexe2f2.php?page=category">Sweaters</a></li>    
                    <li><a href="indexe2f2.php?page=category">Shirts</a></li>                                        
                    <li><a href="indexe2f2.php?page=category">Hoodies</a></li>  
                </ul>
            </div><!-- /.col -->
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">
...
<div class="sidebar-widget product-tag wow fadeInUp">
	...
	<div class="sidebar-widget-body outer-top-xs">
		<div class="tag-list">					
			<a class="item" title="Phone" href="indexe2f2.php?page=category">Phone</a>
			<a class="item active" title="Vest" href="indexe2f2.php?page=category">Vest</a>
			<a class="item" title="Smartphone" href="indexe2f2.php?page=category">Smartphone</a>
			<a class="item" title="Furniture" href="indexe2f2.php?page=category">Furniture</a>
			<a class="item" title="T-shirt" href="indexe2f2.php?page=category">T-shirt</a>
			<a class="item" title="Sweatpants" href="indexe2f2.php?page=category">Sweatpants</a>
			<a class="item" title="Sneaker" href="indexe2f2.php?page=category">Sneaker</a>
			<a class="item" title="Toys" href="indexe2f2.php?page=category">Toys</a>
			<a class="item" title="Rose" href="indexe2f2.php?page=category">Rose</a>
		</div><!-- /.tag-list -->
	</div><!-- /.sidebar-widget-body -->
</div><!-- /.sidebar-widget -->
<!-- ============================================== PRODUCT TAGS : END ============================================== -->
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							<h3 class="name"><a href="indexbd17.php?page=detail">Apple Iphone 5s 32GB Gold</a></h3>
							<div class="rating rateit-small"></div>
			...
			<div class="container-fluid">
				<div class="caption bg-color vertical-center text-left">
					...
					<div class="button-holder fadeInDown-3">
						<a href="index6c11.php?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a>
					</div>
				</div><!-- /.caption -->
			</div><!-- /.container-fluid -->
		</div><!-- /.item -->
...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="indexbd17.php?page=detail"><img  src="assets/images/blank.gif" data-echo="assets/images/products/3.jpg" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="indexbd17.php?page=detail">Apple Iphone 5s 32GB</a></h3>
			<div class="rating rateit-small"></div>
				...
				<div class="action">
					<ul class="list-unstyled">
		                ...
		                <li class="lnk wishlist">
							<a class="add-to-cart" href="indexbd17.php?page=detail" title="Wishlist">
								 <i class="icon fa fa-heart"></i>
							</a>
						</li>

						<li class="lnk">
							<a class="add-to-cart" href="indexbd17.php?page=detail" title="Compare">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="indexbd17.php?page=detail"><img  src="assets/images/blank.gif" data-echo="assets/images/products/4.jpg" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="indexbd17.php?page=detail">LG Smart Phone LP68</a></h3>
			<div class="rating rateit-small"></div>
			<div class="description"></div>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="indexbd17.php?page=detail"><img  src="assets/images/blank.gif" data-echo="assets/images/products/1.jpg" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="indexbd17.php?page=detail">Sony Ericson Vaga</a></h3>
			<div class="rating rateit-small"></div>
			<div class="description"></div>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="indexbd17.php?page=detail"><img  src="assets/images/blank.gif" data-echo="assets/images/products/2.jpg" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="indexbd17.php?page=detail">Samsung Galaxy S4</a></h3>
			<div class="rating rateit-small"></div>
			<div class="description"></div>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="indexbd17.php?page=detail"><img  src="assets/images/blank.gif" data-echo="assets/images/products/6.jpg" alt=""></a>
			</div><!-- /.image -->			
		...
		<div class="product-info text-left">
			<h3 class="name"><a href="indexbd17.php?page=detail">Nokia Lumia 520</a></h3>
			<div class="rating rateit-small"></div>
			<div class="description"></div>
		...
		<div class="owl-carousel blog-slider custom-carousel">
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="indexf6f2.php?page=blog"><img data-echo="assets/images/blog-post/1.jpg" width="270" height="135" src="assets/images/blank.gif" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="indexf6f2.php?page=blog"><img data-echo="assets/images/blog-post/2.jpg" width="270" height="135" src="assets/images/blank.gif" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="indexf6f2.php?page=blog"><img data-echo="assets/images/blog-post/3.jpg" width="270" height="135" src="assets/images/blank.gif" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="indexf6f2.php?page=blog"><img data-echo="assets/images/blog-post/4.jpg" width="270" height="135" src="assets/images/blank.gif" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="indexf6f2.php?page=blog"><img data-echo="assets/images/blog-post/5.jpg" width="270" height="135" src="assets/images/blank.gif" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="indexf6f2.php?page=blog"><img data-echo="assets/images/blog-post/6.jpg" width="270" height="135" src="assets/images/blank.gif" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-padding">
                <div class="copyright">
                   Copyright © 2014
                    <a href="index9ba3.php?page=home">Unicase Shop.</a>
                    - All rights Reserved
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 no-padding">
...
<!-- Mirrored from demo2.chethemes.com/html/unicase/index.php?page-detail by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Aug 2021 11:59:45 GMT -->
</html>